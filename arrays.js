...
// ==========================================
const fewYears = [2021, 2019, 1987, 1984]
console.log(fewYears)
...
// ==========================================
const fewHob = ["Muziek luisteren", "Survival", "Netflix loeren",]
console.log(fewHob)
...
// ==========================================
const someVariables = [3, 4, 7, 2]
console.log(someVariables[0])
...
// ==========================================
const someNumbers = [21, 22, 23, 25, 25]
...
// ==========================================
const someIngredients = ["bladerdeeg", "knoflook", "spinazie"]
someIngredients[0] = "lasagne bladen"
console.log(someIngredients)
console.log(someIngredients.length)