...
const someObjects = {
  ...
  achternaam: "van Dijk",
  leeftijd: 36,
  geboortdatum: "20 augustust 1984",
}
...
console.log("Hoi! ik ben " + someObjects.voornaam + ", ik ben " + someObjects.leeftijd + " jaar oud.")
...
const blaBla4 = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1]
console.log(blaBla4)
